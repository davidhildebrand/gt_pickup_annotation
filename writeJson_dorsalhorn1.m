...
elseif isunix
    masterPath = '/n/groups/htem/temcagt/datasets/dorsalhorn1/roi_generation';
    %masterPath = '/home/lab/170601_P26_Emx_SHH_wt2_r130';
else
    disp('OS error - not Win or Unix');
end
queue_output = [masterPath '/queues/' date '_' num2str(startSectionID) '-' num2str(endSectionID) 'fudged_1.json'];

% saved mask templates for slot and section, respectively, in txt
slot_mask_file = [masterPath '/masks/' 'slot_mask_better_190110_sect496.txt'];
