...
queue_output = [masterPath '/queues/' dt '_cra1_' num2str(startSectionID) '-' num2str(endSectionID) '.json'];
...
for i = 1:length(sectionList)
    ...
    idx3 = find(strcmp(s{1}, 'SECTION2'), 1, 'first');
    idx4 = find(strcmp(s{1}, 'NOITCES2'), 1, 'first');
...
if sectionList(i) == endSectionID
    ...
    if plot_imgs == 1
        ...
        img_save_path = [masterPath '/slot_images_annotated/' num2str(sectionList(i)) '_cra1.png'];
