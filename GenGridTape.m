...
%% NOTES:
%  - This script should be used to generate the GridTapeAlign script for new
%    datasets. It serves as skeleton code, with some lines to be filled
%    in specific to your dataset. These lines include:
%       - Setting masterPath (path to dataset directory on local machine)
%       - Setting slot_mask_file (Identifies where the slot is)
%       - Setting section_mask_file (Identifies where the section is)
%       - Setting focus_mask_file (currently unused, can set to anything)
%       - Setting imPath, which is usualy masterPath + img_links
%  - Search for TODO to find where to set each file
...
%focus_mask_file = [masterPath '/masks/' 'slotMask.txt'];
%% TODO: Set focus_mask
